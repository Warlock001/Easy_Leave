<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminleavemanage.aspx.cs" Inherits="adminleavemanage" %>
...
<div class="bgded"> 
  ...
  <div class="wrapper row2">
    <nav id="mainav" class="hoc clear"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li><a href="empinputform.aspx">Add Employee</a></li>
        <li><a href="empremove.aspx">Remove Employee</a>
          <%--<ul>
  ...
  --%>      </li>
       <%-- <li><a class="drop" href="#">Leave Approval</a>
        ...
        <li><a href="empedit.aspx">Edit Employee</a></li>
