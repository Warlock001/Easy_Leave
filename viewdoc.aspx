l<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewdoc.aspx.cs" Inherits="viewdoc" %>
...
<%--									<li  class="active"><a href="leaveinputform.aspx">New Leave</a></li>--%>
<%--									<li><a href="leavestatus.aspx">Leave Status</a></li>--%>
									...
									<li><a href="uploaddoc.aspx">Submit Documents</a></li>
<%--																	<li><a href="empcpass.aspx">Change Password</a></li>--%>
        ...
        <p>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="#003366" BorderStyle="Solid" CellPadding="4" ForeColor="#333333" GridLines="None" Height="248px" Width="821px">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:BoundField DataField="empid" HeaderText="Emp Id" />
                    <asp:BoundField DataField="empname" HeaderText="Emp Name" />
                    <asp:BoundField DataField="lfrom" HeaderText="From Date" />
                    <asp:BoundField DataField="lto" HeaderText="To Date" />
                    <asp:ImageField DataImageUrlField="image" DataImageUrlFormatString="~/pic/{0}" HeaderText="Leave Document">
                    </asp:ImageField>
                </Columns>
