...
<body>
	...
	<div class="header" id="home">
							...
							<nav class="link-effect-2" id="link-effect-2">
								<ul style="display:inline" class="nav navbar-nav">
									...
									<li><a href="leaveapproval.aspx">Leave Approval</a></li>
                                                                 <li><a href="leaveextension.aspx">Leave Extension</a></li>
		...
		<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#000066" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="leaveid" Height="210px" OnRowDeleting="GridView1_RowDeleting" Width="725px" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
            <Columns>
                <asp:BoundField DataField="empid" HeaderText="Employee ID" />
                <asp:BoundField DataField="empname" HeaderText="Employee Name" />
                <asp:BoundField DataField="lfrom" HeaderText="Leave From" />
                <asp:BoundField DataField="lto" HeaderText="Leave To" />
                <asp:CommandField SelectText="Approve" ShowSelectButton="True" />
                <asp:CommandField DeleteText="Reject" EditText="" ShowDeleteButton="True" />
            </Columns>
