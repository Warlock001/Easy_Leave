<%@ Page Language="C#" AutoEventWireup="true" CodeFile="empedit.aspx.cs" Inherits="empedit" %>
...
<div class="bgded"> 
  ...
  --%>      </li>
      ...
      <!-- ################################################################################################ -->
            ...
            <h1 style="font-size: small">&nbsp;</h1>
            <h1 style="font-size: small; font-weight: bold; text-decoration: underline; color: #CCCCCC;">Edit Employee</h1>

    <form runat="server">
			
		<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataKeyNames="lid" GridLines="Horizontal" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
            <Columns>
